...
import { CHECKOUT_URL, type Plan } from "@/lib/marketing";
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className={`mt-8 inline-flex items-center justify-center rounded-lg px-6 py-4 text-sm font-bold uppercase tracking-wide transition-all ${
          plan.highlight
