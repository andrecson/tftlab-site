...
import { getBuilderChampions } from "@/server/queries/catalog";
...
/** Cached champion catalog for the builder palette. */
...
export default async function BuilderPage() {
  const champions = await getBuilderData();
